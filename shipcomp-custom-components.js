...
const CUSTOM_COMPONENTS = {
  'PowerPlant': {
    ...
    2: [
      ...
      { name: 'Eclipse (power plant)', size: 2, class: 'Stealth', grade: 'A', manufacturer: 'Tyler Design & Tech' },
    ...
    3: [
      ...
      { name: 'Centurion (power plant)', size: 3, class: 'Military', grade: 'C', manufacturer: 'Aegis Dynamics' },
  ...
  'Cooler': {
    ...
    3: [
      ...
      { name: 'Mercury (cooler)', size: 3, class: 'Military', grade: 'C', manufacturer: 'Aegis Dynamics' },
  ...
  'Shield': {
    ...
    1: [
      ...
      { name: 'Guardian (shield generator)', size: 1, class: 'Industrial', grade: 'B', manufacturer: 'Basilisk' },
  ...
  'Radar': {
    ...
    1: [
      ...
      { name: 'Hunter (radar)', size: 1, class: 'Stealth', grade: 'B', manufacturer: 'Blue Triangle Inc.' },
  ...
  'QuantumDrive': {
    1: [
      ...
      { name: 'Beacon (quantum drive)', size: 1, class: 'Military', grade: 'C', manufacturer: 'Wei-Tek' },
      ...
      { name: 'Hyperion (quantum drive)', size: 1, class: 'Civilian', grade: 'B', manufacturer: 'Roberts Space Industries' },
      ...
      { name: 'Vulcan (quantum drive)', size: 1, class: 'Industrial', grade: 'D', manufacturer: 'Juno Starwerk' },
    ...
    3: [
      ...
      { name: 'Echo (quantum drive)', size: 3, class: 'Civilian', grade: 'D', manufacturer: 'ArcCorp' },
      ...
      { name: 'Ranger (quantum drive)', size: 3, class: 'Civilian', grade: 'B', manufacturer: 'Tarsus' },
